let fitnes=['Челленж 27 дней приседаний: 10, 15, 20, 25, 30, отдых, 30, 35, 40, 45, 50, отдых, 50, 55, 60, 65, 70, отдых, 70, 75, 80, 85, 90, отдых, 90, 95, 100.','Челленж 27 дней планка(в секундах): 10, 15, 20, 25, 30, отдых, 30, 35, 40, 45, 50, отдых, 50, 55, 60, 65, 70, отдых, 70, 75, 80, 85, 90, отдых, 90, 95, 100.',
    'Начните вести личный дневник-рефлексию.','Составь план дня в google-таблице и придерживайся его.',
    'Прочитай книгу, которую доолго откладывал на потом','Пройди бесплатный начальный курс по питону на code-basics.',
    'Создай смешной коллаж из старых газет и журналов.','Нарисуй хуманизацию гриба или цветочка.',
    'Купите алоэ или кактус, заботьтесь о нём.','Разберите тот самый завал, который старательно прячете. Выбросьте из дома ненужные вещи',
    'Начните заниматься йогой. Для этого необязательно идти в студию, можно просто медленно разминаться под аудиопадкаст или музыку.','Сделайте то, о чём давно думаете.']
